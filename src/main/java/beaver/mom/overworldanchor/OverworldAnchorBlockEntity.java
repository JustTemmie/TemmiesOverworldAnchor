...
public class OverworldAnchorBlockEntity extends BlockEntity {
    public static final String LODESTONE_POS_KEY = "LodestonePos";

    private BlockPos lodestonePos;

    public OverworldAnchorBlockEntity(BlockPos pos, BlockState state) {
        super(TemmiesOverworldAnchor.OVERWORLD_ANCHOR_BLOCK_ENTITY, pos, state);
    }
