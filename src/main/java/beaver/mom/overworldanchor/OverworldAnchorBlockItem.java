...
public class OverworldAnchorBlockItem extends BlockItem {
    public static final String LODESTONE_POS_KEY = "LodestonePos";

    public OverworldAnchorBlockItem() {
        super(TemmiesOverworldAnchor.OVERWORLD_ANCHOR_BLOCK, new FabricItemSettings());
    }
